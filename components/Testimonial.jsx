...
// sample data for projects with various categoryies
const slides = [
  {
    img: "/assets/testimonial/img-1.png",
    name: "Emma Johnson",
    message:
      "The service was fantastic! Higly recommend it to anyone looking for top noth design.",
  },
  {
  ...
  },
  {
    ...
    message:
      "Everything was delivered on time, and the design exceed my exepectations",
  },
  {
...
const Testimonial = () => {
  ...
  return (
    <div className='py-24 overfolw-hidden'>
                  ...
                  <div className='w-full h-full flex items-end'>
                    <div 
                      className={`${
                        ...
                        } flex items-end rounded-2xl overflow-hidden transiton-all duration-500 relative w-full`}>
                      <Image 
                        src={slide.img} 
