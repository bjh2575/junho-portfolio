...
const Contact = () => {
  const [state, handleSubmit] = useForm("mgvejynb");
    ...
    <section className="pt-8 xl:pt-12 pb-32" id="contact">
      <div className="container mx-auto">
        <div className="flex flex-col items-center xl:flex-row gap-16">
            ...
            <form 
              ...
              <div className="flex gap-8">
                ...
                <div className="flex-1">
                  ...
                  >
                    First Name (이름) <span className="text-accent">*</span>
                  </label>
                  <input 
                ...
                <div className="flex-1">
                  <label 
                    ...
                    className="block mb-2 text-sm font-medium text-primary"
                  >
                    Last Name (성) <span className="text-accent">*</span>
                  </label>
                  <input 
                    onChange={handleChange}
                    type="text" 
              ...
              <div>
                  ...
                  <textarea 
                    ...
                    className="textarea"
                    placeholder="Leave ma a message..."
                    rows="5"
                    required
                  />
                  <ValidationError 
              ...
              >
                {state.submitting ? (
                  ...
                  <>
                    ...
                    <FaCheckCircle 
                      className={`absolute text-whtie text-lg transition-opacity duration-500 ease-in-out ${
                    ...
                    <span
                      className={`transition-opacity duration-500 ease-in-out ${
                        showIcon ? "opacity-0" : "opacity-1000"
                      }`}
                    >
                      Send massage
                    </span>
          ...
          {/* image */}
          <div className="hideen xl:flex relative w-[577px] h-[664px] rounded-lg overflow-hidden">
            <Image 
